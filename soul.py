...
TOKEN = '7501830640:AAGgDQiXnt039INPY8VFu8VMpHVts8fufbU'    
MONGO_URI = 'mongodb+srv://Soul:JYAuvlizhw7wqLOb@soul.tsga4.mongodb.net'
FORWARD_CHANNEL_ID = -1002483871686
CHANNEL_ID = -1002483871686
error_channel_id = -1002483871686
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/canary_download/2*", parse_mode='Markdown')
